...
/** 对话框尺寸（屏幕宽高 → 对话框宽高）。 */
export function dialogSize(width, height) {
...
export function Dialog({ theme, width, height, title, children, }) {
    ...
    return (_jsx(Box, { position: "absolute", top: top, left: left, width: size.width, height: size.height, flexDirection: "column", children: _jsxs(Box, { width: size.width, height: size.height, flexDirection: "column", borderStyle: "round", borderColor: theme.borderFocused, backgroundColor: theme.dialogBg, paddingLeft: 1, paddingRight: 1, children: [_jsx(Text, { bold: true, color: theme.primary, backgroundColor: theme.dialogBg, children: title }), _jsx(Box, { height: 1 }), children] }) }));
}
export function ListDialog({ theme, width, height, title, items, filterable = true, onConfirm, onClose, emptyText = "No items", onRegisterMouse, }) {
