...
const TIPS: Tip[] = [
  ...
  (shortcuts) => press(shortcuts.agentCycle(), "to cycle between Read-Only, Workspace-Write and Full-Access agents"),
  ...
  "Switch agents with {highlight}Tab{/highlight} to control file access before sending a message",
  "The sidebar shows Context, Todo and Modified Files for the current session",
  "Delete a session from the list with {highlight}Ctrl+D{/highlight} (after confirming)",
  "Sessions are stored by DeepSeek Harness and shared with dsh web",
  "Run {highlight}dsh --profile dsh-opencode-tui{/highlight} to launch this interface",
]
